...
log "started"
log "running perl \"$ROOT/service/submitter.pl\" --root \"$ROOT\" --destination \"$DESTINATION\" --log \"$BASELOG\""
perl "$ROOT/service/submitter.pl" --root "$ROOT" --destination "$DESTINATION" --log "$BASELOG"
log "finished"
